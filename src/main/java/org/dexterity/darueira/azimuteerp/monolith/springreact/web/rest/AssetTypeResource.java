...
import org.dexterity.darueira.azimuteerp.monolith.springreact.repository.AssetTypeRepository;
import org.dexterity.darueira.azimuteerp.monolith.springreact.service.AssetTypeService;
...
/**
 * REST controller for managing {@link org.dexterity.darueira.azimuteerp.monolith.springreact.domain.AssetType}.
 */
@RestController
...
public class AssetTypeResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<AssetTypeDTO>> getAllAssetTypes(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
