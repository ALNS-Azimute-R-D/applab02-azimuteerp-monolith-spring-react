...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TYPEOFACTIVITY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TYPEOFACTIVITY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TYPEOFACTIVITY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TYPEOFACTIVITY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TYPEOFACTIVITY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TYPEOFACTIVITY actions', async () => {
      const arg = 42666;
