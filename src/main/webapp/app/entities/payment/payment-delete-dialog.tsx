...
export const PaymentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="azimuteErpSpringReactMonolith03App.payment.delete.question">
        <Translate contentKey="azimuteErpSpringReactMonolith03App.payment.delete.question" interpolate={{ id: paymentEntity.id }}>
