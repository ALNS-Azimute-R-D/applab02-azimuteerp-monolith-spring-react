...
export const PersonDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="azimuteErpSpringReactMonolith03App.person.delete.question">
        <Translate contentKey="azimuteErpSpringReactMonolith03App.person.delete.question" interpolate={{ id: personEntity.id }}>
