...
export const AssetTypeDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/asset-type' + pageLocation.search);
  };
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(assetTypeEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="azimuteErpSpringReactMonolith03App.assetType.delete.question">
        <Translate contentKey="azimuteErpSpringReactMonolith03App.assetType.delete.question" interpolate={{ id: assetTypeEntity.id }}>
...
export default AssetTypeDeleteDialog;
