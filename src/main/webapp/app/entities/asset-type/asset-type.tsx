  ...
  return (
    <div>
      <h2 id="asset-type-heading" data-cy="AssetTypeHeading">
        <Translate contentKey="azimuteErpSpringReactMonolith03App.assetType.home.title">Asset Types</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="azimuteErpSpringReactMonolith03App.assetType.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/asset-type/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="azimuteErpSpringReactMonolith03App.assetType.home.createLabel">Create new Asset Type</Translate>
          </Link>
        </div>
      </h2>
        ...
        {assetTypeList && assetTypeList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="azimuteErpSpringReactMonolith03App.assetType.id">ID</Translate>{' '}
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        onClick={() =>
                          (window.location.href = `/asset-type/${assetType.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="azimuteErpSpringReactMonolith03App.assetType.home.notFound">No Asset Types found</Translate>
            </div>
          )
        )}
      </div>
