...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASSETTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ASSETTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ASSETTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ASSETTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ASSETTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ASSETTYPE actions', async () => {
      const arg = 42666;
