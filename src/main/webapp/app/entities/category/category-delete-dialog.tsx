...
export const CategoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="azimuteErpSpringReactMonolith03App.category.delete.question">
        <Translate contentKey="azimuteErpSpringReactMonolith03App.category.delete.question" interpolate={{ id: categoryEntity.id }}>
