...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './organization-attribute.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORGANIZATIONATTRIBUTE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ORGANIZATIONATTRIBUTE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ORGANIZATIONATTRIBUTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ORGANIZATIONATTRIBUTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ORGANIZATIONATTRIBUTE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ORGANIZATIONATTRIBUTE actions', async () => {
      const arg = 42666;
