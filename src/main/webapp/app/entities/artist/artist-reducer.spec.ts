...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './artist.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARTIST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ARTIST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ARTIST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ARTIST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ARTIST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ARTIST actions', async () => {
      const arg = 42666;
