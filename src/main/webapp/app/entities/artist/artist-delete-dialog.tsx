...
export const ArtistDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/artist' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="azimuteErpSpringReactMonolith03App.artist.delete.question">
        <Translate contentKey="azimuteErpSpringReactMonolith03App.artist.delete.question" interpolate={{ id: artistEntity.id }}>
