...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './organization-member-role.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORGANIZATIONMEMBERROLE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ORGANIZATIONMEMBERROLE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ORGANIZATIONMEMBERROLE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ORGANIZATIONMEMBERROLE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ORGANIZATIONMEMBERROLE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ORGANIZATIONMEMBERROLE actions', async () => {
      const arg = 42666;
