...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './organization-role.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORGANIZATIONROLE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ORGANIZATIONROLE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ORGANIZATIONROLE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ORGANIZATIONROLE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ORGANIZATIONROLE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ORGANIZATIONROLE actions', async () => {
      const arg = 42666;
