...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EVENTATTENDEE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EVENTATTENDEE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EVENTATTENDEE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EVENTATTENDEE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EVENTATTENDEE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EVENTATTENDEE actions', async () => {
      const arg = 42666;
