...
export const CustomerDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="azimuteErpSpringReactMonolith03App.customer.delete.question">
        <Translate contentKey="azimuteErpSpringReactMonolith03App.customer.delete.question" interpolate={{ id: customerEntity.id }}>
