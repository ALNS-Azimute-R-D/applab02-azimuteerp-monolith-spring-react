...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './organization-membership.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORGANIZATIONMEMBERSHIP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ORGANIZATIONMEMBERSHIP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ORGANIZATIONMEMBERSHIP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ORGANIZATIONMEMBERSHIP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ORGANIZATIONMEMBERSHIP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ORGANIZATIONMEMBERSHIP actions', async () => {
      const arg = 42666;
