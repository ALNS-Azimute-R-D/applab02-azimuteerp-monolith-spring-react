...
export const DistrictDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="azimuteErpSpringReactMonolith03App.district.delete.question">
        <Translate contentKey="azimuteErpSpringReactMonolith03App.district.delete.question" interpolate={{ id: districtEntity.id }}>
