...
export const AssetDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="azimuteErpSpringReactMonolith03App.asset.delete.question">
        <Translate contentKey="azimuteErpSpringReactMonolith03App.asset.delete.question" interpolate={{ id: assetEntity.id }}>
