...
export const OrderDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="azimuteErpSpringReactMonolith03App.order.delete.question">
        <Translate contentKey="azimuteErpSpringReactMonolith03App.order.delete.question" interpolate={{ id: orderEntity.id }}>
