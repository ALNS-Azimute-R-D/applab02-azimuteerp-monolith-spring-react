...
export const PaymentGatewayDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="azimuteErpSpringReactMonolith03App.paymentGateway.delete.question">
        <Translate
          contentKey="azimuteErpSpringReactMonolith03App.paymentGateway.delete.question"
          interpolate={{ id: paymentGatewayEntity.id }}
        >
