  ...
  return (
    <div>
      <h2 id="payment-gateway-heading" data-cy="PaymentGatewayHeading">
        <Translate contentKey="azimuteErpSpringReactMonolith03App.paymentGateway.home.title">Payment Gateways</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="azimuteErpSpringReactMonolith03App.paymentGateway.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/payment-gateway/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="azimuteErpSpringReactMonolith03App.paymentGateway.home.createLabel">
        ...
        {paymentGatewayList && paymentGatewayList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="azimuteErpSpringReactMonolith03App.paymentGateway.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('aliasCode')}>
                  <Translate contentKey="azimuteErpSpringReactMonolith03App.paymentGateway.aliasCode">Alias Code</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('aliasCode')} />
                </th>
            ...
            <tbody>
              {paymentGatewayList.map((paymentGateway, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`azimuteErpSpringReactMonolith03App.ActivationStatusEnum.${paymentGateway.activationStatus}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="azimuteErpSpringReactMonolith03App.paymentGateway.home.notFound">No Payment Gateways found</Translate>
            </div>
          )
        )}
      </div>
