...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTGATEWAY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PAYMENTGATEWAY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PAYMENTGATEWAY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PAYMENTGATEWAY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTGATEWAY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PAYMENTGATEWAY actions', async () => {
      const arg = 42666;
