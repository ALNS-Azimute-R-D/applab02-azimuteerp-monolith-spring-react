...
export const ProvinceDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/province' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="azimuteErpSpringReactMonolith03App.province.delete.question">
        <Translate contentKey="azimuteErpSpringReactMonolith03App.province.delete.question" interpolate={{ id: provinceEntity.id }}>
