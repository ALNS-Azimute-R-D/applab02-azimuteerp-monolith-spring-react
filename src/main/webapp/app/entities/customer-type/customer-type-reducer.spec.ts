...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUSTOMERTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CUSTOMERTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CUSTOMERTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CUSTOMERTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CUSTOMERTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CUSTOMERTYPE actions', async () => {
      const arg = 42666;
