...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TYPEOFARTMEDIA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TYPEOFARTMEDIA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TYPEOFARTMEDIA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TYPEOFARTMEDIA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TYPEOFARTMEDIA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TYPEOFARTMEDIA actions', async () => {
      const arg = 42666;
