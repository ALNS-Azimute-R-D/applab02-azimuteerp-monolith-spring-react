...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TYPEOFPERSON_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TYPEOFPERSON actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TYPEOFPERSON actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TYPEOFPERSON actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TYPEOFPERSON actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TYPEOFPERSON actions', async () => {
      const arg = 42666;
