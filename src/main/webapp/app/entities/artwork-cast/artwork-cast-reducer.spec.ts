...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARTWORKCAST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ARTWORKCAST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ARTWORKCAST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ARTWORKCAST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ARTWORKCAST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ARTWORKCAST actions', async () => {
      const arg = 42666;
