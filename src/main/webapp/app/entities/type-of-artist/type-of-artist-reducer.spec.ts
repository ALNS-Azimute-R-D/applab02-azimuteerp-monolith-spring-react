...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TYPEOFARTIST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TYPEOFARTIST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TYPEOFARTIST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TYPEOFARTIST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TYPEOFARTIST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TYPEOFARTIST actions', async () => {
      const arg = 42666;
