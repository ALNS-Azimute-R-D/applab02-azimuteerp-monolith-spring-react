...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STOCKLEVEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STOCKLEVEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STOCKLEVEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STOCKLEVEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STOCKLEVEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STOCKLEVEL actions', async () => {
      const arg = 42666;
