...
export const OrganizationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="azimuteErpSpringReactMonolith03App.organization.delete.question">
        <Translate contentKey="azimuteErpSpringReactMonolith03App.organization.delete.question" interpolate={{ id: organizationEntity.id }}>
