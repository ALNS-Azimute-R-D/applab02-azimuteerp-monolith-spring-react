...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASSETCOLLECTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ASSETCOLLECTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ASSETCOLLECTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ASSETCOLLECTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ASSETCOLLECTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ASSETCOLLECTION actions', async () => {
      const arg = 42666;
