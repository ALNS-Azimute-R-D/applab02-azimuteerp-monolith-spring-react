...
export const EventDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="azimuteErpSpringReactMonolith03App.event.delete.question">
        <Translate contentKey="azimuteErpSpringReactMonolith03App.event.delete.question" interpolate={{ id: eventEntity.id }}>
