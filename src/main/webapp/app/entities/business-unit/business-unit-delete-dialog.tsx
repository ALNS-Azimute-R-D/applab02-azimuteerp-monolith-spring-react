...
export const BusinessUnitDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/business-unit' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="azimuteErpSpringReactMonolith03App.businessUnit.delete.question">
        <Translate contentKey="azimuteErpSpringReactMonolith03App.businessUnit.delete.question" interpolate={{ id: businessUnitEntity.id }}>
