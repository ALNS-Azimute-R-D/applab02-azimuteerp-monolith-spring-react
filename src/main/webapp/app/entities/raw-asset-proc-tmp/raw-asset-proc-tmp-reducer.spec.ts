...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './raw-asset-proc-tmp.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RAWASSETPROCTMP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RAWASSETPROCTMP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RAWASSETPROCTMP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RAWASSETPROCTMP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RAWASSETPROCTMP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RAWASSETPROCTMP actions', async () => {
      const arg = 42666;
