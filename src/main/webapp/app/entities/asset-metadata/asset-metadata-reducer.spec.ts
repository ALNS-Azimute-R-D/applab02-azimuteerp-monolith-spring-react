...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASSETMETADATA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ASSETMETADATA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ASSETMETADATA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ASSETMETADATA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ASSETMETADATA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ASSETMETADATA actions', async () => {
      const arg = 42666;
