...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TICKETPURCHASED_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TICKETPURCHASED actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TICKETPURCHASED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TICKETPURCHASED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TICKETPURCHASED actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TICKETPURCHASED actions', async () => {
      const arg = 42666;
