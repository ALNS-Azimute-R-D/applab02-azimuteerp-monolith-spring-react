...
export const ActivityDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="azimuteErpSpringReactMonolith03App.activity.delete.question">
        <Translate contentKey="azimuteErpSpringReactMonolith03App.activity.delete.question" interpolate={{ id: activityEntity.id }}>
