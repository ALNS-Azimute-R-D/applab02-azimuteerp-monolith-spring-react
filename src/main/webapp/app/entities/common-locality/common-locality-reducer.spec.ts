...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMMONLOCALITY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMMONLOCALITY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMMONLOCALITY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_COMMONLOCALITY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_COMMONLOCALITY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMMONLOCALITY actions', async () => {
      const arg = 42666;
