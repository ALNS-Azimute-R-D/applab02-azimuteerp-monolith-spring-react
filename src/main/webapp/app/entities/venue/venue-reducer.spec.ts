...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './venue.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VENUE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VENUE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VENUE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VENUE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VENUE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VENUE actions', async () => {
      const arg = 42666;
