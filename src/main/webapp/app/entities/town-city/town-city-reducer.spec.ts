...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './town-city.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOWNCITY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TOWNCITY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TOWNCITY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TOWNCITY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TOWNCITY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TOWNCITY actions', async () => {
      const arg = 42666;
