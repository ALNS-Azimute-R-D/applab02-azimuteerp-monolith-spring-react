...
export const ArtworkDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/artwork' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="azimuteErpSpringReactMonolith03App.artwork.delete.question">
        <Translate contentKey="azimuteErpSpringReactMonolith03App.artwork.delete.question" interpolate={{ id: artworkEntity.id }}>
