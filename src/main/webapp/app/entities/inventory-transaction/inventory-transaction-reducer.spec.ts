...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './inventory-transaction.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INVENTORYTRANSACTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INVENTORYTRANSACTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INVENTORYTRANSACTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INVENTORYTRANSACTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INVENTORYTRANSACTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INVENTORYTRANSACTION actions', async () => {
      const arg = 42666;
