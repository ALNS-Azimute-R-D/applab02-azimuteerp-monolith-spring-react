...
export const WarehouseDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="azimuteErpSpringReactMonolith03App.warehouse.delete.question">
        <Translate contentKey="azimuteErpSpringReactMonolith03App.warehouse.delete.question" interpolate={{ id: warehouseEntity.id }}>
