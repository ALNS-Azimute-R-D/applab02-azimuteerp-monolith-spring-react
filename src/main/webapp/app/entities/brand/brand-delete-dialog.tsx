...
export const BrandDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="azimuteErpSpringReactMonolith03App.brand.delete.question">
        <Translate contentKey="azimuteErpSpringReactMonolith03App.brand.delete.question" interpolate={{ id: brandEntity.id }}>
