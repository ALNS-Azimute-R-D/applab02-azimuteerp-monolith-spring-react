...
export const ArticleDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/article' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="azimuteErpSpringReactMonolith03App.article.delete.question">
        <Translate contentKey="azimuteErpSpringReactMonolith03App.article.delete.question" interpolate={{ id: articleEntity.id }}>
