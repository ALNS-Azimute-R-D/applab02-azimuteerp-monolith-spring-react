...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARTISTICGENRE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ARTISTICGENRE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ARTISTICGENRE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ARTISTICGENRE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ARTISTICGENRE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ARTISTICGENRE actions', async () => {
      const arg = 42666;
