...
export const OrderItemDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="azimuteErpSpringReactMonolith03App.orderItem.delete.question">
        <Translate contentKey="azimuteErpSpringReactMonolith03App.orderItem.delete.question" interpolate={{ id: orderItemEntity.id }}>
