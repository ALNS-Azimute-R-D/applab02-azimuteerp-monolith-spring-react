...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EVENTPROGRAM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EVENTPROGRAM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EVENTPROGRAM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EVENTPROGRAM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EVENTPROGRAM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EVENTPROGRAM actions', async () => {
      const arg = 42666;
