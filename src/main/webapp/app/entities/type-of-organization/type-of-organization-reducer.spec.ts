...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './type-of-organization.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TYPEOFORGANIZATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TYPEOFORGANIZATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TYPEOFORGANIZATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TYPEOFORGANIZATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TYPEOFORGANIZATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TYPEOFORGANIZATION actions', async () => {
      const arg = 42666;
