...
export const ProductDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="azimuteErpSpringReactMonolith03App.product.delete.question">
        <Translate contentKey="azimuteErpSpringReactMonolith03App.product.delete.question" interpolate={{ id: productEntity.id }}>
