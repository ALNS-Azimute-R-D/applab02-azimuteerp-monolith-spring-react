...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './organization-domain.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORGANIZATIONDOMAIN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ORGANIZATIONDOMAIN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ORGANIZATIONDOMAIN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ORGANIZATIONDOMAIN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ORGANIZATIONDOMAIN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ORGANIZATIONDOMAIN actions', async () => {
      const arg = 42666;
