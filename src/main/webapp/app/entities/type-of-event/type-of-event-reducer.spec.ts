...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TYPEOFEVENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TYPEOFEVENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TYPEOFEVENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TYPEOFEVENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TYPEOFEVENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TYPEOFEVENT actions', async () => {
      const arg = 42666;
