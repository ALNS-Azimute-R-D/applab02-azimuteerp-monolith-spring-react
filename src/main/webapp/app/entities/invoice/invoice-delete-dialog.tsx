...
export const InvoiceDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="azimuteErpSpringReactMonolith03App.invoice.delete.question">
        <Translate contentKey="azimuteErpSpringReactMonolith03App.invoice.delete.question" interpolate={{ id: invoiceEntity.id }}>
