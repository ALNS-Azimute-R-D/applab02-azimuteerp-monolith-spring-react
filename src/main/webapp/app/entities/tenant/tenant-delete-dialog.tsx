...
export const TenantDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="azimuteErpSpringReactMonolith03App.tenant.delete.question">
        <Translate contentKey="azimuteErpSpringReactMonolith03App.tenant.delete.question" interpolate={{ id: tenantEntity.id }}>
