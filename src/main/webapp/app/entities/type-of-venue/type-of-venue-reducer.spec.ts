...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TYPEOFVENUE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TYPEOFVENUE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TYPEOFVENUE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TYPEOFVENUE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TYPEOFVENUE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TYPEOFVENUE actions', async () => {
      const arg = 42666;
