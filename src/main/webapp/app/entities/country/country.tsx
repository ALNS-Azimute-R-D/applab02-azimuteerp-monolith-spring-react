  ...
  return (
    <div>
      <h2 id="country-heading" data-cy="CountryHeading">
        <Translate contentKey="azimuteErpSpringReactMonolith03App.country.home.title">Countries</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="azimuteErpSpringReactMonolith03App.country.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/country/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="azimuteErpSpringReactMonolith03App.country.home.createLabel">Create new Country</Translate>
          </Link>
        </div>
      </h2>
        ...
        {countryList && countryList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="azimuteErpSpringReactMonolith03App.country.id">ID</Translate>{' '}
                ...
                <th className="hand" onClick={sort('continent')}>
                  ...
                  <FontAwesomeIcon icon={getSortIconByFieldName('continent')} />
                </th>
            ...
            <tbody>
              {countryList.map((country, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{country.name}</td>
                  <td>
                    <Translate contentKey={`azimuteErpSpringReactMonolith03App.ContinentEnum.${country.continent}`} />
                  </td>
                  <td>
                    {country.geoPolygonArea ? (
                      <div>
                        {country.geoPolygonAreaContentType ? (
                          <a onClick={openFile(country.geoPolygonAreaContentType, country.geoPolygonArea)}>
                            <Translate contentKey="entity.action.open">Open</Translate>
                            &nbsp;
                          </a>
                        ) : null}
                        <span>
                          {country.geoPolygonAreaContentType}, {byteSize(country.geoPolygonArea)}
                        </span>
                      </div>
                    ) : null}
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="azimuteErpSpringReactMonolith03App.country.home.notFound">No Countries found</Translate>
            </div>
          )
        )}
      </div>
