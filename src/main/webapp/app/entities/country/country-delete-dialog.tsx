...
export const CountryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="azimuteErpSpringReactMonolith03App.country.delete.question">
        <Translate contentKey="azimuteErpSpringReactMonolith03App.country.delete.question" interpolate={{ id: countryEntity.id }}>
