...
import org.dexterity.darueira.azimuteerp.monolith.springreact.service.mapper.TypeOfActivityMapper;
...
class TypeOfActivityResourceIT {
    ...
    void partialUpdateTypeOfActivityWithPatch() throws Exception {
        ...
        partialUpdatedTypeOfActivity.description(UPDATED_DESCRIPTION);
