...
import org.dexterity.darueira.azimuteerp.monolith.springreact.domain.enumeration.ContinentEnum;
import org.dexterity.darueira.azimuteerp.monolith.springreact.repository.CountryRepository;
import org.dexterity.darueira.azimuteerp.monolith.springreact.service.dto.CountryDTO;
import org.dexterity.darueira.azimuteerp.monolith.springreact.service.mapper.CountryMapper;
...
class CountryResourceIT {
    ...
    @Test
    @Transactional
    void checkContinentIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
