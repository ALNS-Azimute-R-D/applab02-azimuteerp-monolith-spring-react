...
import static org.dexterity.darueira.azimuteerp.monolith.springreact.web.rest.TestUtil.createUpdateProxyForBean;
import static org.dexterity.darueira.azimuteerp.monolith.springreact.web.rest.TestUtil.sameNumber;
...
import org.dexterity.darueira.azimuteerp.monolith.springreact.IntegrationTest;
...
import org.dexterity.darueira.azimuteerp.monolith.springreact.domain.enumeration.EventStatusEnum;
import org.dexterity.darueira.azimuteerp.monolith.springreact.repository.EventRepository;
import org.dexterity.darueira.azimuteerp.monolith.springreact.service.EventService;
import org.dexterity.darueira.azimuteerp.monolith.springreact.service.dto.EventDTO;
import org.dexterity.darueira.azimuteerp.monolith.springreact.service.mapper.EventMapper;
...
class EventResourceIT {
    ...
    private static final BigDecimal DEFAULT_DEFAULT_TICKET_VALUE = new BigDecimal(1);
    private static final BigDecimal UPDATED_DEFAULT_TICKET_VALUE = new BigDecimal(2);

    private static final EventStatusEnum DEFAULT_STATUS = EventStatusEnum.IN_PREVIEM;
    private static final EventStatusEnum UPDATED_STATUS = EventStatusEnum.DRAFT;
    ...
    public static Event createEntity(EntityManager em) {
        Event event = new Event()
            ...
            .defaultTicketValue(DEFAULT_DEFAULT_TICKET_VALUE)
            .status(DEFAULT_STATUS)
            .activationStatus(DEFAULT_ACTIVATION_STATUS);
        // Add required entity
        TypeOfEvent typeOfEvent;
        if (TestUtil.findAll(em, TypeOfEvent.class).isEmpty()) {
            typeOfEvent = TypeOfEventResourceIT.createEntity(em);
            em.persist(typeOfEvent);
            em.flush();
        } else {
            typeOfEvent = TestUtil.findAll(em, TypeOfEvent.class).get(0);
        }
    ...
    public static Event createUpdatedEntity(EntityManager em) {
        Event event = new Event()
            ...
            .defaultTicketValue(UPDATED_DEFAULT_TICKET_VALUE)
            .status(UPDATED_STATUS)
            .activationStatus(UPDATED_ACTIVATION_STATUS);
        // Add required entity
        TypeOfEvent typeOfEvent;
        if (TestUtil.findAll(em, TypeOfEvent.class).isEmpty()) {
            typeOfEvent = TypeOfEventResourceIT.createUpdatedEntity(em);
            em.persist(typeOfEvent);
            em.flush();
        } else {
            typeOfEvent = TestUtil.findAll(em, TypeOfEvent.class).get(0);
    ...
    @Test
    @Transactional
    void checkDefaultTicketValueIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        event.setDefaultTicketValue(null);
    ...
    void checkActivationStatusIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        event.setActivationStatus(null);
    ...
    void getAllEvents() throws Exception {
        ...
        restEventMockMvc
            ...
            .andExpect(jsonPath("$.[*].defaultTicketValue").value(hasItem(sameNumber(DEFAULT_DEFAULT_TICKET_VALUE))))
    ...
    void getEvent() throws Exception {
        ...
        restEventMockMvc
            ...
            .andExpect(jsonPath("$.defaultTicketValue").value(sameNumber(DEFAULT_DEFAULT_TICKET_VALUE)))
