...
import org.dexterity.darueira.azimuteerp.monolith.springreact.service.mapper.ArtistMapper;
...
class ArtistResourceIT {
    ...
    void partialUpdateArtistWithPatch() throws Exception {
        ...
        partialUpdatedArtist.realName(UPDATED_REAL_NAME).biographyDetailsJSON(UPDATED_BIOGRAPHY_DETAILS_JSON);
