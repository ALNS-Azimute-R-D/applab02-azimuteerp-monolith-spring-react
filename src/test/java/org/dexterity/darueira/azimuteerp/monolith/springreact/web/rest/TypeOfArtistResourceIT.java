...
import org.dexterity.darueira.azimuteerp.monolith.springreact.repository.TypeOfArtistRepository;
import org.dexterity.darueira.azimuteerp.monolith.springreact.service.dto.TypeOfArtistDTO;
import org.dexterity.darueira.azimuteerp.monolith.springreact.service.mapper.TypeOfArtistMapper;
...
class TypeOfArtistResourceIT {
    ...
    void partialUpdateTypeOfArtistWithPatch() throws Exception {
        ...
        partialUpdatedTypeOfArtist.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
