...
import org.dexterity.darueira.azimuteerp.monolith.springreact.repository.ProgramRepository;
import org.dexterity.darueira.azimuteerp.monolith.springreact.service.dto.ProgramDTO;
import org.dexterity.darueira.azimuteerp.monolith.springreact.service.mapper.ProgramMapper;
...
class ProgramResourceIT {
    ...
    void partialUpdateProgramWithPatch() throws Exception {
        ...
        partialUpdatedProgram.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).fullDescription(UPDATED_FULL_DESCRIPTION);
