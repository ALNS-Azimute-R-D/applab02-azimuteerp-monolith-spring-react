...
import org.dexterity.darueira.azimuteerp.monolith.springreact.repository.CustomerTypeRepository;
import org.dexterity.darueira.azimuteerp.monolith.springreact.service.dto.CustomerTypeDTO;
import org.dexterity.darueira.azimuteerp.monolith.springreact.service.mapper.CustomerTypeMapper;
...
class CustomerTypeResourceIT {
    ...
    void partialUpdateCustomerTypeWithPatch() throws Exception {
        ...
        partialUpdatedCustomerType.name(UPDATED_NAME);
