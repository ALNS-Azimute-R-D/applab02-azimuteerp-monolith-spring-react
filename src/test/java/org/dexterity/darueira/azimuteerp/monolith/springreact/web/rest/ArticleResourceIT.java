...
import org.dexterity.darueira.azimuteerp.monolith.springreact.domain.enumeration.SizeOptionEnum;
...
import org.dexterity.darueira.azimuteerp.monolith.springreact.service.mapper.ArticleMapper;
...
class ArticleResourceIT {
    ...
    void partialUpdateArticleWithPatch() throws Exception {
        ...
        partialUpdatedArticle.skuCode(UPDATED_SKU_CODE).customName(UPDATED_CUSTOM_NAME).itemSize(UPDATED_ITEM_SIZE);
