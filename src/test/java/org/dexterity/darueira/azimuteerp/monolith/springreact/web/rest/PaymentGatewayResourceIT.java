...
import org.dexterity.darueira.azimuteerp.monolith.springreact.repository.PaymentGatewayRepository;
import org.dexterity.darueira.azimuteerp.monolith.springreact.service.dto.PaymentGatewayDTO;
import org.dexterity.darueira.azimuteerp.monolith.springreact.service.mapper.PaymentGatewayMapper;
...
class PaymentGatewayResourceIT {
    ...
    void partialUpdatePaymentGatewayWithPatch() throws Exception {
        ...
        partialUpdatedPaymentGateway.businessHandlerClazz(UPDATED_BUSINESS_HANDLER_CLAZZ).activationStatus(UPDATED_ACTIVATION_STATUS);
