...
describe('CustomerType e2e test', () => {
  ...
  const customerTypeSample = { name: 'off' };
  ...
  describe('CustomerType page', () => {
    ...
    describe('with existing value', () => {
      ...
      it('last delete button click should delete instance of CustomerType', () => {
        cy.intercept('GET', '/api/customer-types/*').as('dialogDeleteRequest');
  ...
  describe('new CustomerType page', () => {
    ...
    it('should create an instance of CustomerType', () => {
      cy.get(`[data-cy="name"]`).type('treat aha whose');
      cy.get(`[data-cy="name"]`).should('have.value', 'treat aha whose');

      cy.get(`[data-cy="description"]`).type('masculine');
      cy.get(`[data-cy="description"]`).should('have.value', 'masculine');

      cy.get(`[data-cy="businessHandlerClazz"]`).type('bangle');
      cy.get(`[data-cy="businessHandlerClazz"]`).should('have.value', 'bangle');
