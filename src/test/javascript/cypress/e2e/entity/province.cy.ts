...
describe('Province e2e test', () => {
  ...
  const provinceSample = { acronym: 'loo', name: 'bob lest stretcher' };
  ...
  describe('Province page', () => {
    ...
    describe('with existing value', () => {
      ...
      it('last delete button click should delete instance of Province', () => {
        cy.intercept('GET', '/api/provinces/*').as('dialogDeleteRequest');
  ...
  describe('new Province page', () => {
    ...
    it('should create an instance of Province', () => {
      cy.get(`[data-cy="acronym"]`).type('dri');
      cy.get(`[data-cy="acronym"]`).should('have.value', 'dri');

      cy.get(`[data-cy="name"]`).type('what');
      cy.get(`[data-cy="name"]`).should('have.value', 'what');
