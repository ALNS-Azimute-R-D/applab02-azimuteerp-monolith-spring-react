...
describe('AssetCollection e2e test', () => {
  ...
  const assetCollectionSample = { name: 'out for tenet', activationStatus: 'INVALID' };
  ...
  describe('AssetCollection page', () => {
    ...
    describe('with existing value', () => {
      ...
      it('last delete button click should delete instance of AssetCollection', () => {
        cy.intercept('GET', '/api/asset-collections/*').as('dialogDeleteRequest');
  ...
  describe('new AssetCollection page', () => {
    ...
    it('should create an instance of AssetCollection', () => {
      cy.get(`[data-cy="name"]`).type('enormous energetic');
      cy.get(`[data-cy="name"]`).should('have.value', 'enormous energetic');

      cy.get(`[data-cy="fullFilenamePath"]`).type('out whoever');
      cy.get(`[data-cy="fullFilenamePath"]`).should('have.value', 'out whoever');
