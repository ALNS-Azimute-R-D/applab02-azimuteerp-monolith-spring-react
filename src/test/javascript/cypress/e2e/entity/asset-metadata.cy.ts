...
describe('AssetMetadata e2e test', () => {
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      method: 'POST',
      url: '/api/assets',
      body: {"name":"as phew","storageTypeUsed":"AWS_S3","fullFilenamePath":"aha save regarding","status":"ENABLED","preferredPurpose":"EXECUTABLE_PROGRAM_BINARY","assetContentAsBlob":"Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci5wbmc=","assetContentAsBlobContentType":"unknown","activationStatus":"ACTIVE"},
    }).then(({ body }) => {
      asset = body;
    });
  });
  ...
  describe('AssetMetadata page', () => {
    ...
    describe('with existing value', () => {
      ...
      it.skip('last delete button click should delete instance of AssetMetadata', () => {
        cy.intercept('GET', '/api/asset-metadata/*').as('dialogDeleteRequest');
  ...
  describe('new AssetMetadata page', () => {
    ...
    it.skip('should create an instance of AssetMetadata', () => {
      cy.get(`[data-cy="metadataDetailsJSON"]`).type('gracefully');
      cy.get(`[data-cy="metadataDetailsJSON"]`).should('have.value', 'gracefully');
