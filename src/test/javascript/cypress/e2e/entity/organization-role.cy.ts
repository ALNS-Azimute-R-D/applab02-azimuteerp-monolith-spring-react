...
describe('OrganizationRole e2e test', () => {
  ...
  // const organizationRoleSample = {"roleName":"mostly veldt without","activationStatus":"BLOCKED"};
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      ...
      body: {"acronym":"throughout frenetica","businessCode":"even frozen","hierarchicalLevel":"uh-huh along whoa","name":"bah atomize","description":"postmark oh","businessHandlerClazz":"windscreen","mainContactPersonDetailsJSON":"litmus fluffy consignment","technicalEnvironmentsDetailsJSON":"scientist","customAttributesDetailsJSON":"flint ethical badly","organizationStatus":"UNDER_EVALUATION","activationStatus":"ON_HOLD","logoImg":"Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci5wbmc=","logoImgContentType":"unknown"},
    }).then(({ body }) => {
      organization = body;
    });
  });
  ...
  describe('OrganizationRole page', () => {
    ...
    describe('with existing value', () => {
      ...
      it.skip('last delete button click should delete instance of OrganizationRole', () => {
        cy.intercept('GET', '/api/organization-roles/*').as('dialogDeleteRequest');
  ...
  describe('new OrganizationRole page', () => {
    ...
    it.skip('should create an instance of OrganizationRole', () => {
      cy.get(`[data-cy="roleName"]`).type('pat chill');
      cy.get(`[data-cy="roleName"]`).should('have.value', 'pat chill');
