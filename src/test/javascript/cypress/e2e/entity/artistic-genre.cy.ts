...
describe('ArtisticGenre e2e test', () => {
  ...
  const artisticGenreSample = { acronym: 'after moral', name: 'lest', description: 'before ack' };
  ...
  describe('ArtisticGenre page', () => {
    ...
    describe('with existing value', () => {
      ...
      it('last delete button click should delete instance of ArtisticGenre', () => {
        cy.intercept('GET', '/api/artistic-genres/*').as('dialogDeleteRequest');
  ...
  describe('new ArtisticGenre page', () => {
    ...
    it('should create an instance of ArtisticGenre', () => {
      cy.get(`[data-cy="acronym"]`).type('gosh');
      cy.get(`[data-cy="acronym"]`).should('have.value', 'gosh');

      cy.get(`[data-cy="name"]`).type('defiantly');
      cy.get(`[data-cy="name"]`).should('have.value', 'defiantly');

      cy.get(`[data-cy="description"]`).type('however helpfully aw');
      cy.get(`[data-cy="description"]`).should('have.value', 'however helpfully aw');
