...
describe('Brand e2e test', () => {
  ...
  const brandSample = { acronym: 'amidst annually', name: 'truck' };
  ...
  describe('new Brand page', () => {
    ...
    it('should create an instance of Brand', () => {
      cy.get(`[data-cy="acronym"]`).type('patriot shrivel');
      cy.get(`[data-cy="acronym"]`).should('have.value', 'patriot shrivel');

      cy.get(`[data-cy="name"]`).type('psst');
      cy.get(`[data-cy="name"]`).should('have.value', 'psst');

      cy.get(`[data-cy="description"]`).type('sharply delightful');
      cy.get(`[data-cy="description"]`).should('have.value', 'sharply delightful');
