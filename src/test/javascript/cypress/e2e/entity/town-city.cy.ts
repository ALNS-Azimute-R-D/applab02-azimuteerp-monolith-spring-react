...
describe('TownCity e2e test', () => {
  ...
  // const townCitySample = {"acronym":"spending","name":"even"};
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      method: 'POST',
      url: '/api/provinces',
      body: {"acronym":"how","name":"hmph","geoPolygonArea":"Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci5wbmc=","geoPolygonAreaContentType":"unknown"},
    }).then(({ body }) => {
      province = body;
    });
  });
  ...
  describe('TownCity page', () => {
    ...
    describe('with existing value', () => {
      ...
      it.skip('last delete button click should delete instance of TownCity', () => {
        cy.intercept('GET', '/api/town-cities/*').as('dialogDeleteRequest');
  ...
  describe('new TownCity page', () => {
    ...
    it.skip('should create an instance of TownCity', () => {
      cy.get(`[data-cy="acronym"]`).type('innocent');
      cy.get(`[data-cy="acronym"]`).should('have.value', 'innocent');

      cy.get(`[data-cy="name"]`).type('loftily manipulation scotch');
      cy.get(`[data-cy="name"]`).should('have.value', 'loftily manipulation scotch');
