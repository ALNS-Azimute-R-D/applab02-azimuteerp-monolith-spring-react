...
describe('TypeOfPerson e2e test', () => {
  ...
  const typeOfPersonSample = { code: 'garag', description: 'winding witness' };
  ...
  describe('TypeOfPerson page', () => {
    ...
    describe('with existing value', () => {
      ...
      it('last delete button click should delete instance of TypeOfPerson', () => {
        cy.intercept('GET', '/api/type-of-people/*').as('dialogDeleteRequest');
  ...
  describe('new TypeOfPerson page', () => {
    ...
    it('should create an instance of TypeOfPerson', () => {
      cy.get(`[data-cy="code"]`).type('plagu');
      cy.get(`[data-cy="code"]`).should('have.value', 'plagu');

      cy.get(`[data-cy="description"]`).type('since');
      cy.get(`[data-cy="description"]`).should('have.value', 'since');
