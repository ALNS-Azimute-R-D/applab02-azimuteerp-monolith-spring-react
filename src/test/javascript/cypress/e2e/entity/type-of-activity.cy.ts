...
describe('TypeOfActivity e2e test', () => {
  ...
  const typeOfActivitySample = { name: 'female' };
  ...
  describe('TypeOfActivity page', () => {
    ...
    describe('with existing value', () => {
      ...
      it('last delete button click should delete instance of TypeOfActivity', () => {
        cy.intercept('GET', '/api/type-of-activities/*').as('dialogDeleteRequest');
  ...
  describe('new TypeOfActivity page', () => {
    ...
    it('should create an instance of TypeOfActivity', () => {
      cy.get(`[data-cy="acronym"]`).type('when');
      cy.get(`[data-cy="acronym"]`).should('have.value', 'when');

      cy.get(`[data-cy="name"]`).type('boo oh indeed');
      cy.get(`[data-cy="name"]`).should('have.value', 'boo oh indeed');

      cy.get(`[data-cy="description"]`).type('awesome although wherever');
      cy.get(`[data-cy="description"]`).should('have.value', 'awesome although wherever');

      cy.get(`[data-cy="handlerClazzName"]`).type('monster past like');
      cy.get(`[data-cy="handlerClazzName"]`).should('have.value', 'monster past like');
