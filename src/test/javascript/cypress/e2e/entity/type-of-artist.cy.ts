...
describe('TypeOfArtist e2e test', () => {
  ...
  const typeOfArtistSample = { acronym: 'annual following partition', name: 'athletic instead', description: 'vice' };
  ...
  describe('TypeOfArtist page', () => {
    ...
    describe('with existing value', () => {
      ...
      it('last delete button click should delete instance of TypeOfArtist', () => {
        cy.intercept('GET', '/api/type-of-artists/*').as('dialogDeleteRequest');
  ...
  describe('new TypeOfArtist page', () => {
    ...
    it('should create an instance of TypeOfArtist', () => {
      cy.get(`[data-cy="acronym"]`).type('disembodiment amused wraparound');
      cy.get(`[data-cy="acronym"]`).should('have.value', 'disembodiment amused wraparound');

      cy.get(`[data-cy="name"]`).type('inside');
      cy.get(`[data-cy="name"]`).should('have.value', 'inside');

      cy.get(`[data-cy="description"]`).type('yowza');
      cy.get(`[data-cy="description"]`).should('have.value', 'yowza');
