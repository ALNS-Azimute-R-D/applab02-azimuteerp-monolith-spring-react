...
describe('Category e2e test', () => {
  ...
  const categorySample = { name: 'time inheritance' };
  ...
  describe('new Category page', () => {
    ...
    it('should create an instance of Category', () => {
      cy.get(`[data-cy="acronym"]`).type('tog');
      cy.get(`[data-cy="acronym"]`).should('have.value', 'tog');

      cy.get(`[data-cy="name"]`).type('regress as');
      cy.get(`[data-cy="name"]`).should('have.value', 'regress as');

      cy.get(`[data-cy="description"]`).type('or plus');
      cy.get(`[data-cy="description"]`).should('have.value', 'or plus');

      cy.get(`[data-cy="handlerClazzName"]`).type('wholly');
      cy.get(`[data-cy="handlerClazzName"]`).should('have.value', 'wholly');
