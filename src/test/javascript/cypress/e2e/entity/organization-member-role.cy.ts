...
describe('OrganizationMemberRole e2e test', () => {
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      ...
      body: {"joinedAt":"2024-06-09","activationStatus":"ACTIVE"},
    }).then(({ body }) => {
    ...
    cy.authenticatedRequest({
      ...
      body: {"roleName":"flare aboard","activationStatus":"INACTIVE"},
    }).then(({ body }) => {
  ...
  describe('OrganizationMemberRole page', () => {
    ...
    describe('with existing value', () => {
      ...
      it.skip('last delete button click should delete instance of OrganizationMemberRole', () => {
        cy.intercept('GET', '/api/organization-member-roles/*').as('dialogDeleteRequest');
