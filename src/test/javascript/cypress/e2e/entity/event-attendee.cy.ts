...
describe('EventAttendee e2e test', () => {
  ...
  const eventAttendeeSample = { attendedAsRole: 'hmph than' };
  ...
  describe('EventAttendee page', () => {
    ...
    describe('with existing value', () => {
      ...
      it('last delete button click should delete instance of EventAttendee', () => {
        cy.intercept('GET', '/api/event-attendees/*').as('dialogDeleteRequest');
  ...
  describe('new EventAttendee page', () => {
    ...
    it('should create an instance of EventAttendee', () => {
      cy.get(`[data-cy="attendedAsRole"]`).type('metal rapid as');
      cy.get(`[data-cy="attendedAsRole"]`).should('have.value', 'metal rapid as');
      ...
      cy.get(`[data-cy="ticketNumber"]`).type('consequently');
      cy.get(`[data-cy="ticketNumber"]`).should('have.value', 'consequently');

      cy.get(`[data-cy="seatNumber"]`).type('into');
      cy.get(`[data-cy="seatNumber"]`).should('have.value', 'into');
