...
describe('TypeOfOrganization e2e test', () => {
  ...
  const typeOfOrganizationSample = { acronym: 'alongside clearly', name: 'ah failing', description: 'now' };
  ...
  describe('TypeOfOrganization page', () => {
    ...
    describe('with existing value', () => {
      ...
      it('last delete button click should delete instance of TypeOfOrganization', () => {
        cy.intercept('GET', '/api/type-of-organizations/*').as('dialogDeleteRequest');
  ...
  describe('new TypeOfOrganization page', () => {
    ...
    it('should create an instance of TypeOfOrganization', () => {
      cy.get(`[data-cy="acronym"]`).type('quicker');
      cy.get(`[data-cy="acronym"]`).should('have.value', 'quicker');

      cy.get(`[data-cy="name"]`).type('drat reserve');
      cy.get(`[data-cy="name"]`).should('have.value', 'drat reserve');

      cy.get(`[data-cy="description"]`).type('amidst dehydrate wherever');
      cy.get(`[data-cy="description"]`).should('have.value', 'amidst dehydrate wherever');

      cy.get(`[data-cy="businessHandlerClazz"]`).type('warlock sequester');
      cy.get(`[data-cy="businessHandlerClazz"]`).should('have.value', 'warlock sequester');
