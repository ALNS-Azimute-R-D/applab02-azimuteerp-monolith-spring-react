...
describe('Product e2e test', () => {
  ...
  const productSample = { listPrice: 18669.18, discontinued: true, activationStatus: 'INACTIVE' };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="productSKU"]`).type('supposing crossly');
      cy.get(`[data-cy="productSKU"]`).should('have.value', 'supposing crossly');

      cy.get(`[data-cy="productName"]`).type('for');
      cy.get(`[data-cy="productName"]`).should('have.value', 'for');

      cy.get(`[data-cy="description"]`).type('mmm roughly');
      cy.get(`[data-cy="description"]`).should('have.value', 'mmm roughly');

      cy.get(`[data-cy="standardCost"]`).type('10385.43');
      cy.get(`[data-cy="standardCost"]`).should('have.value', '10385.43');

      cy.get(`[data-cy="listPrice"]`).type('16615.74');
      cy.get(`[data-cy="listPrice"]`).should('have.value', '16615.74');

      cy.get(`[data-cy="reorderLevel"]`).type('14080');
      cy.get(`[data-cy="reorderLevel"]`).should('have.value', '14080');

      cy.get(`[data-cy="targetLevel"]`).type('29998');
      cy.get(`[data-cy="targetLevel"]`).should('have.value', '29998');

      cy.get(`[data-cy="quantityPerUnit"]`).type('likewise');
      cy.get(`[data-cy="quantityPerUnit"]`).should('have.value', 'likewise');
      ...
      cy.get(`[data-cy="minimumReorderQuantity"]`).type('25862');
      cy.get(`[data-cy="minimumReorderQuantity"]`).should('have.value', '25862');

      cy.get(`[data-cy="suggestedCategory"]`).type('the');
      cy.get(`[data-cy="suggestedCategory"]`).should('have.value', 'the');
